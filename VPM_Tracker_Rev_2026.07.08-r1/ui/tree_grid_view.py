...
class TreeGridView(QTreeWidget):
    ...
    def open_context_menu(self, position: QPoint):
        ...
        if item:
            ...
            clicked_col = self.columnAt(position.x())
            if clicked_col == Columns.DELAY:
                ...
                menu.addAction(mark_track_action)
                ...
                menu.addAction(set_delay_action)
