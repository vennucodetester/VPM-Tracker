...
def detect_or_setup_repo(parent=None):
    ...
    # Only work inside the folder where Git Helper is located.
    # Do NOT fall back to the current working directory because that can
    # accidentally attach to a parent folder (for example C:\PYTHON).
    ...
    raw_candidates.append(app_folder)
    candidates = []
    seen = set()
